    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "אבי נימני סוכנות שחקנים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('http://localhost:5001/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'c75755b0-c87d-4129-b26a-48e1f7f6965a',
                    name: data.name || '',
                    email: data.email || '',
